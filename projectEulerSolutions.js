/* 
 * Solutions to the Project Euler problems by Ashley Wharton
...
function solveProblem2() {
	...
	// Sum the even valued terms - utilising the observed odd-even pattern of the Fibonacci sequence (OEOOEOOEOOE...), 
